...
[![x-cmd/install — pkgx Code Quality Monitoring Repo Card](https://repo.x-cmd.io/pkgx.svg?lang=zh)](https://x-cmd.com/install/pkgx)
...
合计: **2,983** 行代码（覆盖前 5 种语言、共 **38** 个文件）。
...
- **上游仓库**: <https://github.com/pkgxdev/pkgx>
- **官网**: <https://pkgx.sh>
- **许可证**: Apache-2.0
...
- **Star**: 9,922 · **Fork**: 1,390 · **开放 issue**: 464 · **贡献者**: 64

## 累计统计

- **发布数**: 235 · **已合并 PR**: 459 · **开放 PR**: 1 · **已关闭 issue**: 433 · **开放 issue**: 31 · **提交数**: 1324

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-22 | 0 | 1 | 1 | 0 | 0 | 0 |
| last60d | 2026-07-23 | 0 | 4 | 1 | 0 | 0 | 3 |
| 90d | 2026-06-23 | 2 | 8 | 1 | 0 | 1 | 7 |
| last180d | 2026-03-25 | 6 | 21 | 1 | 0 | 3 | 13 |
| 360d | 2025-09-26 | 8 | 53 | 1 | 3 | 7 | 71 |
| last720d | 2024-10-01 | 28 | 126 | 1 | 38 | 22 | 299 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pkgx.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T04:58:39Z._
